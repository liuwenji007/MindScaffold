...
license: MIT
compatibility: "React Native 0.74+, Expo SDK 51+"
globs: ["**/*.tsx", "**/*.jsx"]
metadata:
  author: vercel
  version: "1.0.0"
  source: vercel-labs/agent-skills
  upstream_path: skills/react-native-skills
  tags: [react-native, expo, mobile, performance]
  impact: high
  domains: [frontend]
---
...
For the complete guide with all rules expanded: `AGENTS.md` (reference only, not loaded by default).
